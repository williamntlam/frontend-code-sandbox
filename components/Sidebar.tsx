        ...
        <section className="text-center">
          <nav>
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/code">
                  <button className="hover:text-blue-600 transition-colors duration-900 font-bold bg-gradient-to-r from-red-600 via-yellow-600 to-blue-600 bg-clip-text text-transparent">
                    Code Playground
                  </button>
                </Link>
              </li>
