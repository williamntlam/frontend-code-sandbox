...
export default function Templates() {
  ...
  return (
    <main className="p-5">
      <div>
        <h2 className="text-3xl text-bold">Templates</h2>
          ...
          <ul className="flex flex-wrap -mx-2 -my-2">
            {projects.map((project, index) => (
              <button>
                <li
                  key={index}
                  className="bg-gradient-to-br from-black via-blue-900 to-blue-700 w-48 h-48 m-2 flex flex-col justify-center items-center p-4 rounded-lg shadow-lg transition transform hover:scale-105 hover:shadow-xl"
                >
