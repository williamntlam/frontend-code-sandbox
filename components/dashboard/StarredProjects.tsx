          ...
          <ul className="flex flex-wrap -mx-2 -my-2">
            {projects.map((project, index) => (
              <button>
                <li
                  key={index}
                  className="bg-yellow-500 w-48 h-48 m-2 flex flex-col justify-center items-center p-4 rounded-lg shadow-lg transition transform hover:scale-105 hover:shadow-xl"
                >
